...
* możliwości **ReSharpera**: edycja kodu, refaktoryzacja, nawigacja i analiza projektu
* wsparcie testów **NUnit** i dodatków do ReSharpera
* przykłady wykorzystania narzędzia w codziennej pracy