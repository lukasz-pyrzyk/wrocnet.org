...
Dwie prelekcje – na pierwszy ogień temat rekrutacji w prelekcji **"Nie strzel sobie w stopę."** {% include speaker.html id="karol-rogowski" %}. A następnie {% include speaker.html id="mateusz-konicki" %} wciągnie nas w świat **cybersecurity w CI/CD**.
...
**👨🏼‍🎓{% include speaker.html id="mateusz-konicki" %}**
