...
#### Continous delivery story with FIFA - {% include speaker.html id="miroslaw-jedynak" %}
...
#### Deployment automation & Continous deployment - {% include speaker.html id="szymon-pobiega" %}
